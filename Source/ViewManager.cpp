...
*
* This method adjusts the camera movement speed when the 
* mouse scroll wheel is used.
************************************************************/
void ViewManager::Mouse_Scroll_Callback(GLFWwindow* window, double xOffset, double yOffset)
{
	//make sure the camera exists before trying to use it
	if (NULL == g_pCamera)
	{
		return;
	}

	//adjust the camera movement speed with the mouse wheel
	g_pCamera->MovementSpeed += static_cast<float>(yOffset);

	// keep the movement speed within a reasonable range
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process camera panning down and up
